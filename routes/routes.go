...
import (
	...
	"github.com/kerlenton/mservice/config"
	"github.com/kerlenton/mservice/controllers"
	"github.com/kerlenton/mservice/database"
	"github.com/kerlenton/mservice/middleware"
	"github.com/kerlenton/mservice/queue"
)
...
func SetupRouter(cfg *config.Config) (*gin.Engine, error) {
	...
	r.Use(cors.New(cors.Config{
		AllowOrigins:     []string{"*"}, // стоит сузить в проде
